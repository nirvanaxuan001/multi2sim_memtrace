...
static char *mem_debug_file_name1 = "";
...
static void m2s_read_command_line(int *argc_ptr, char **argv)
{
	...
	for (argi = 1; argi < argc; argi++)
	{
        ...
        if (!strcmp(argv[argi], "--mem-debug1"))
        {
            m2s_need_argument(argc, argv, argi);
            mem_debug_file_name1 = argv[++argi];
            continue;
        }
...
int main(int argc, char **argv)
{
    ...
    mem_debug_category1 = debug_new_category(mem_debug_file_name1);
